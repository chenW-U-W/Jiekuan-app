...
//        self.backgroundColor = [UIColor clearColor];
       ...
       // _stateLabel.textAlignment = UITextAlignmentCenter;//deprecated in 6.0
        ...
        //_dateLabel.textAlignment = UITextAlignmentCenter;//deprecated in 6.0
    ...
    if (_state != state) {
        ...
        if (_state == kPRStateLoading) {    //Loading
            ...
            if (!self.isAtTop) {    //footer
                _arrow.hidden = YES;
                _stateLabel.text = NSLocalizedString(@"", @"");//footer 的显示 没有了喽
            }
        }
    }
}
...
- (void)flashMessage:(NSString *)msg{
    ...
    if (_msgLabel == nil) {
        ...
        _msgLabel.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"导航栏底色-家长"]];
